...
/* Configure bit timing parameters for eCANA*/
    ...
    ECanaRegs.CANBTC.all = ECanaShadow.CANBTC.all;      //把影子CAN的CANBTC寄存器的值都赋给CAN真正的寄存器
